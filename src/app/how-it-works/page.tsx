...
export default function HowItWorksPage() {
  return (
    <div className="mx-auto w-full max-w-4xl px-2 py-10 sm:px-4">
      ...
      <section id="the-concept" className="mt-10 scroll-mt-24">
        <h2 className="text-xl font-semibold text-[var(--foreground)]">The Concept</h2>
        <p className="mt-3 text-base leading-relaxed text-[var(--foreground-muted)]">
          Traditional real estate is reactive—you wait for someone to sell. HomePosal is proactive. We allow “Suitors”
          to express interest in any property they’ve always wanted, and we allow Owners to discover that interest
          before they ever deal with the stress of the MLS.
        </p>
      </section>
        ...
        <ol className="mt-4 space-y-4">
          <li className="rounded-xl border border-[var(--border)] bg-[var(--background-elevated)] p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[var(--foreground-muted)]">
              Our bulletin board is public. Anyone can see the current proposals being made on properties across
              Southern California. It’s a real-time map of market demand.
            </p>
          </li>
          <li className="rounded-xl border border-[var(--border)] bg-[var(--background-elevated)] p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[var(--foreground-muted)]">
              ...
              keep the board high-quality, we verify your Proof of Funds so owners know you are a serious, qualified
              Suitor.
            </p>
          </li>
          <li className="rounded-xl border border-[var(--border)] bg-[var(--background-elevated)] p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[var(--foreground-muted)]">
              Before you hire a photographer, stage your home, or sign a listing agreement, check HomePosal. See if
              there is already a proposal waiting for you. There is zero pressure; you only reach out to us if a
              proposal meets your terms.
            </p>
          </li>
        </ol>
      </section>

      <section id="why-homeposal" className="mt-10 scroll-mt-24">
        <h2 className="text-xl font-semibold text-[var(--foreground)]">Why HomePosal?</h2>
            ...
            <table className="min-w-[720px] w-full border-collapse bg-white text-left text-sm">
              ...
              <tbody className="divide-y divide-[var(--border)]">
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 text-[var(--foreground-muted)]">Any property in SoCal is open for a proposal.</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 text-[var(--foreground-muted)]">100% Owner-driven. You decide if and when to talk.</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section id="faq" className="mt-10 scroll-mt-24">
        ...
        <div className="mt-4 space-y-4">
          <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[var(--foreground-muted)]">
              No. It is a public bulletin board. This transparency allows the community to see where the market is
              moving and what properties are in high demand.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-4">
            <p className="text-sm font-semibold text-[var(--foreground)]">
              As a Suitor, what properties can I propose on?
            </p>
            <p className="mt-2 text-sm leading-relaxed text-[var(--foreground-muted)]">
              Anything in Southern California. If you’ve driven by a house for years and wished it was yours, HomePosal
              gives you a formal way to let the owner know you are a serious buyer with verified funds.
            </p>
          </div>
      ...
      <section className="mt-10">
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--background-elevated)] p-5">
          <p className="text-base font-semibold text-[var(--foreground)]">
            Don&apos;t list it until you check it.
          </p>
        </div>
      </section>
    </div>
