...
export async function POST(req: NextRequest) {
  ...
  const system = [
    ...
    "- Invite Proposals: Want to test the market? Request a Proposal Window—social notification and a professional yard sign; you stay in control (see How it Works — Choose Your Path (Owners) / Invite Proposals).",
